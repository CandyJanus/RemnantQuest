...
public class Stage1_RemnantQuest_BarEvent extends BaseBarEventWithPerson {


    // mission stages
    public static enum Stage {
        ACT1_GIVE_QUEST,
        ACT2_ENCOUNTER_TARGET,
        ACT3_DIALOGUE_WITH_ROBOT,
    }
    ...
    public boolean shouldShowAtMarket(MarketAPI market) {
        ...
        return super.shouldShowAtMarket(market) && market.getFactionId().equals("tri");
    }
        ...
        if (optionData instanceof OptionId) {
            ...
            switch(option){
                ...
                case DOUBLE_DOWN_1:
                    ...
                    options.addOption("Do it again.", OptionId.DOUBLE_DOWN_1);
                    options.addOption("Solid hit. There's nothing more to be done here.", OptionId.EXIT);
                    break;
                case APOLOGIZE_1:
                ...
                case APOLOGIZE_2:
                    ...
                    options.addOption("\"You too, friend.\"", OptionId.EXIT);
                    break;
                case EXIT:
                    noContinue=true;
                    done=true;
